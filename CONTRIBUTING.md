Contributing to Dogecoin Private Core
============================

The Dogecoin Private Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dogecoin Private Core project, and is not to be
confused with overall DOGP Network Protocol consensus changes.

Whether a pull request is merged into Dogecoin Private Core rests with the project merge
...
Patches that change DOGP consensus rules are considerably more involved than
...
Where a patch set proposes to change the DOGP consensus, it must have been
...
The project leader is the release manager for each Dogecoin Private Core release.
