...
#   c) node1 mines 32 blocks, so now node 0 has 60001dogp, node 1 has 4250dogp, node2 has none.
#   d) node0 sends 601 dogp to node2, in two transactions (301 dogp, then 300 dogp).
