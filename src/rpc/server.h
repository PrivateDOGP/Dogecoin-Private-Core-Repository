...
extern UniValue setzdogpseed(const UniValue& params, bool fHelp);
extern UniValue getzdogpseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzdogp(const UniValue& params, bool fHelp);
extern UniValue dzdogpstate(const UniValue& params, bool fHelp);
