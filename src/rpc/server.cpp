...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DOGP features */
        {"dogecoinprivate", "masternode", &masternode, true, true, false},
        {"dogecoinprivate", "listmasternodes", &listmasternodes, true, true, false},
        {"dogecoinprivate", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dogecoinprivate", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dogecoinprivate", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"dogecoinprivate", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"dogecoinprivate", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"dogecoinprivate", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dogecoinprivate", "masternodedebug", &masternodedebug, true, true, false},
        {"dogecoinprivate", "startmasternode", &startmasternode, true, true, false},
        {"dogecoinprivate", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dogecoinprivate", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dogecoinprivate", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dogecoinprivate", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dogecoinprivate", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dogecoinprivate", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dogecoinprivate", "mnbudget", &mnbudget, true, true, false},
        {"dogecoinprivate", "preparebudget", &preparebudget, true, true, false},
        {"dogecoinprivate", "submitbudget", &submitbudget, true, true, false},
        {"dogecoinprivate", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dogecoinprivate", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dogecoinprivate", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dogecoinprivate", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dogecoinprivate", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dogecoinprivate", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dogecoinprivate", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dogecoinprivate", "checkbudgets", &checkbudgets, true, true, false},
        {"dogecoinprivate", "mnsync", &mnsync, true, true, false},
        {"dogecoinprivate", "spork", &spork, true, true, false},
        {"dogecoinprivate", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzdogpseed", &getzdogpseed, false, false, true},
        {"zerocoin", "setzdogpseed", &setzdogpseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdogp", &searchdzdogp, false, false, true},
        {"zerocoin", "dzdogpstate", &dzdogpstate, false, false, true}
...
{
    return "> dogecoinprivate-cli " + methodname + " " + args + "\n";
}
