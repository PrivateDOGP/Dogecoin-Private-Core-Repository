...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitCoinOne Core dogecoinprivate-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dogecoinprivate-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dogecoinprivate transaction") + "\n" +
                               "  dogecoinprivate-tx [options] -create [commands]   " + _("Create hex-encoded dogecoinprivate transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dogecoinprivate transaction
