...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dogecoin Private Core"),
     ...
     * override -datadir in the dogecoinprivate.conf file in the default data directory
     * (to be consistent with dogecoinprivated behavior)
     */
    if (dataDir != getDefaultDataDirectory())
