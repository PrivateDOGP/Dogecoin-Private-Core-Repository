                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDOGPPathCustom = GetArg("-zdogpbackuppath", "");
    ...
    if(!strzDOGPPathCustom.empty()) {
        ui->wallet_customzdogpbackuppath->setText(QString::fromStdString(strzDOGPPathCustom));
        ui->wallet_customzdogpbackuppath_label->setVisible(true);
        ui->wallet_customzdogpbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDOGPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DOGP RPC console.") + "<br>" +
