...
#define QAPP_ORG_NAME "DOGP"
#define QAPP_ORG_DOMAIN "dogecoinprivate.org"
#define QAPP_APP_NAME_DEFAULT "Dogecoin-Private-Qt"
#define QAPP_APP_NAME_TESTNET "Dogecoin-Private-Qt-testnet"
