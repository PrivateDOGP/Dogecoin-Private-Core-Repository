...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::DOGP);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBitCoinOneAmount"))
        SoftSetArg("-anonymizedogecoinprivateamount", settings.value("nAnonymizeBitCoinOneAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in dogecoinprivate.cpp during shotdown to also remove the window positions
