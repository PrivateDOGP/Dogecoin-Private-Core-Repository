...
/** Utility functions used by the DOGP Qt UI.
 */
namespace GUIUtil
{
...
// Render DOGP addresses in monospace font
...
// Parse "dogecoinprivate:" URI into recipient object, return true on successful parsing
