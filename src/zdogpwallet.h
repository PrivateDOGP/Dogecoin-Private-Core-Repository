...
#ifndef DOGP_zDOGPWALLET_H
#define DOGP_zDOGPWALLET_H
...
public:
    CzDOGPWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczDOGP(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozDOGP(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //DOGP_zDOGPWALLET_H
