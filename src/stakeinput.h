...
#ifndef DOGP_STAKEINPUT_H
#define DOGP_STAKEINPUT_H
...
public:
    ...
    virtual bool IszDOGP() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zDOGPStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zdogp, which is a zcspend that has successfully staked
...
public:
    ...
    bool IszDOGP() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IszDOGP() override { return false; }
};


#endif //DOGP_STAKEINPUT_H
