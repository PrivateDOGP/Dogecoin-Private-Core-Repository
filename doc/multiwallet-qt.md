...
In order to support loading of multiple wallets in dogecoinprivate-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dogecoinprivate.cpp.
...
Changes to dogecoinprivate.cpp
----------------------
dogecoinprivate.cpp is the entry point into dogecoinprivate-qt, and as such, will require some minor modifications to provide hooks for
