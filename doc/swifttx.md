...
This mechanism has been integrated into Bitcore-Node-DOGP which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DOGP-Project/insight-api-dogecoinprivate#web-socket-api](https://github.com/DOGP-Project/insight-api-dogecoinprivate#web-socket-api) 
* API: [https://github.com/DOGP-Project/insight-api-dogecoinprivate#swifttx-transactions](https://github.com/DOGP-Project/insight-api-dogecoinprivate#swifttx-transactions) 
...
By default, the Dogecoin Private Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dogecoin Private Core daemon:
